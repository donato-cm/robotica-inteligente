...
def orientate (xgoal, ygoal):
    ...
    cmd_vel_topic3 = '/turtle3/cmd_vel'
...
def go_to_goal (xgoal, ygoal):
    ...
    velocity_message = Twist()
    cmd_vel_topic3 = '/turtle4/cmd_vel'
...
if __name__ == '__main__':
    try:
        ...
        #t1
        cmd_vel_topic4 = '/turtle4/cmd_vel'
        velocity_publisher = rospy.Publisher(cmd_vel_topic4, Twist, queue_size = 10)
